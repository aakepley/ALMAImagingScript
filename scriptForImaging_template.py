...
#>>>  aU.genImageName(vis=finalvis,spw=list(map(int,spw.split(','))),field=int(field.split('~')[0]),imtype='cube',targettype='sci',stokes='I',mous='',modtext='manual',spwmap=list(map(int,sciencespws.split(','))))
