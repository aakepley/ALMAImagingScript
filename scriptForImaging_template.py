...
#>>> =====================================================================================#
#>>>
#>>> Updated: Wed Apr 25 09:34:17 EDT 2018
...
#>>>  aU.genImageName(vis=finalvis,spw=map(int,spw.split(',')),field=int(field.split('~')[0]),imtype='cube',targettype='sci',stokes='I',mous='',modtext='manual',spwmap=sciencespws)
